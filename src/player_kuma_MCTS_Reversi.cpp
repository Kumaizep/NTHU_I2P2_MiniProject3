...
const int weight[SIZE][SIZE] = {{ 99,  -8,  8,  6,  6,  8,  -8, 99},
								{ -8, -24, -4, -3, -3, -4, -24, -8},
								{  8,  -4,  7,  4,  4,  7,  -4,  8},
								{  6,  -3,  4,  0,  0,  4,  -3,  6},
								{  6,  -3,  4,  0,  0,  4,  -3,  6},
...
Point MCTS(Node* root, int round) {
	while (round--) {
...
void write_valid_spot(std::ofstream& fout) {
	...
	Point p = MCTS(root, floor(2000));
	std::cout << "choice " << p.x << " " << p.y << " in " << std::clock() - start_time << std::endl;
